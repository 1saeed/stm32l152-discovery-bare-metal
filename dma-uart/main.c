 ...
 *
 * Purpose:   
 * send a message from memory to uart-TX using DMA
 *
 *
 * Configuration:
 * dma:
 ...
 * 6- set source address in DMA_CMARx register for message array
...
static unsigned char msg[] = "This message has been sent by DMA\r\n";
		    ...
		    // if transfer is completed
				...
				{					
					  DMA1_Channel4->CCR		&= (unsigned int)~0x00000001;		// disable dma
						...
						DMA1_Channel4->CNDTR	=  sizeof(msg);									// number of data to transfer								
 ...
 void dma_init(void)
 {
	  ...
	  DMA1_Channel4->CMAR   =  (unsigned int)msg;						// set source address
